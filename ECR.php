...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<a href="engagement.php" ><img src="images/eng1.jpg" title="img1" /><br>
						<h3>COUPLE RING</h3></a>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='ECR'";					
					...
					echo "<h4>Product Id : " . $pid . "<br>";	
					echo "<h4>Name :  " . $rows["p_name"] . "<br>";	
					echo "<h4>Price : Rs " . $price;					
