...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<img src="images/nak1.jpg" title="rigns" /><br>
						<h3>Beads Necklace</h3>
						<p>Neck Pack Necklace to suit every ocassion.</p>
					</div>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='NNBN'";					
