...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<img src="images/dom2.jpg" title="rigns" /><br>
						<h3>Single Diamond Ear Tops</h3>
						<p>Single Diamond Ear Tops to match any outfit</p>
					</div>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='ERSD'";					
