...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<img src="images/ring2.jpg" title="rigns" /><br>
						<h3>Bride's Rings</h3></a>
						<p>A huge collection to get the perfect match for your bride's outfit.</p>
					</div>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='RRBR'";					
