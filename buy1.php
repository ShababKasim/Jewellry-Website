...
<html>
	<head>
		<title>Successful:: Jewellerystore</title>
	...
	<body>
			...
			<div class="about">
				...
				<h1>Your order has been placed and will be delivered within 3 - 4 business days</h1><br>
				<h1>Order in the name of <?php echo $_SESSION['username'] ?></h1>
				<h1>Product Name: <?php echo $_SESSION['pname'] ?></h1>
				<h1>Quantity: <?php echo $_SESSION['qty'] ?></h1>
				<h1>Total amount: <?php echo $_SESSION['price'] ?></h1>
				<h1> <a href="payment.php">Click here</a> to pay </h1>
