...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<img src="images/nec.jpg" title="rigns" width="300" height="180" /><br>
						<h3>White Gold & Diamond Necklaces</h3>
						<p>The Beauty Of with Gold with the charm of diamond to it.</p>
					</div>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='NNWH'";					
