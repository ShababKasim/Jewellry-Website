...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<img src="images/der.png" title="rigns" /><br>
						<h3>Platinum Ear-Rings</h3>
						<p>The beauty Of Platinum with Diamonds.</p>
					</div>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='ERPE'";					
