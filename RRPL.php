...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<img src="images/ring1.jpg" title="rigns" /><br>
						<h3>Platinum Collection</h3></a>
						<p>Variety of platinum rings to be selected from.</p>
					</div>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='RRPL'";					
