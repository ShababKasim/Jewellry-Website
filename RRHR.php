...
<html>
	...
	<body>
			...
			<div class="about">
				<div class="grid box">
						<img src="images/ring3.jpg" title="rigns" /><br>
						<h3>Heart Rings</h3>
						<p>Show your love with the symbol of love. Heart Collection exclusively for sharing the love</p>
					</div>
				...
				<div class="about-rights">
					...
					include("table.html");
					$sql = "select p_id,p_name,p_price from product WHERE p_id='RRHR'";					
